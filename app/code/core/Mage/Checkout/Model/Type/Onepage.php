...
class Mage_Checkout_Model_Type_Onepage
{
    ...
    public function saveBilling($data, $customerAddressId)
    {
        ...
        $_SESSION['nit'] = $data['nit'];
        $_SESSION['document_type'] = $data['document_type'];
        $address = $this->getQuote()->getBillingAddress();
        $this->getQuote()->setData("nit",$data['nit']);
    ...
    protected function _prepareNewCustomerQuote()
    {
        ...
        $customer->setNit($_SESSION['nit']);
        $customer->setDocument_type($_SESSION['document_type']);
