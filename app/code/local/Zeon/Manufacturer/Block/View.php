...
class Zeon_Manufacturer_Block_View extends Mage_Catalog_Block_Product_Abstract
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($breadcrumbs = $this->getLayout()->getBlock('breadcrumbs')) {
                ...
                $breadcrumbs->addCrumb('manufacturers_list', array('label'=>$helper->__('Manufacturers'), 'title'=>$helper->__('Manufacturers'), 'link'=>Mage::getUrl('marcas')));
        ...
        if ($head) {
        	 $idManu = $manufacturer->getManufacturer();
        	 $DB = Mage::getSingleton('core/resource')->getConnection('core_write');
		     $query = "SELECT meta_keywords,meta_description FROM zeon_manufacturer WHERE manufacturer = '$idManu'";
