...
class Ofi_Adminhtml_Sales_OrderController extends Mage_Adminhtml_Sales_OrderController
{
    /**
    ...
    {        
        if ($order = $this->_initOrder()) {
            ...
            //MAOBEL
            Mage::log("CANCEL ORDER ID ".$order->getId(),null,'cancel.log');
            $this->_redirect('*/sales_order/view', array('order_id' => $order->getId()));
        }
    }
    ...
    public function massCancelAction()
    {
        ...
        foreach ($orderIds as $orderId) {
            ...
            //MAOBEL
            Mage::log("CANCEL ORDER ID ".$orderId,null,'cancel.log');
        }
