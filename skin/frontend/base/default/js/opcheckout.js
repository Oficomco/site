...
Checkout.prototype = {
    ...
    setMethod: function(){
        if ($('login:guest') && $('login:guest').checked) {
            ...
            alert(Translator.translate('Por favor seleccion registrarse o realizar la comprar como invitado').stripTags());
            return false;
        }
...
Payment.prototype = {
    ...
    validate: function() {
        ...
        alert(Translator.translate('Por favor especifique el método de pago.').stripTags());
        return false;
    },
